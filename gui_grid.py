...
def gui_load():
    ...
    if value == 0:
        ...
        bitToCheckbox(mbr,cpu.mbr.get_value())
...
for i in range (23,35):
  pc_list.append(IntVar())
  tk.Checkbutton(otherFrame, text='', variable=pc_list[i-23], bg="#97ecf7").grid(row=1,column=i)
...
def stepCheck():  
  ...
  bitToCheckbox(pc_list,helper_functions.decimal_to_bit_array_unsigned(int(cpu.pc.get_value()),cpu.pc.get_register_size()))
