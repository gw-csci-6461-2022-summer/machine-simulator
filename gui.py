...
btn1 = tk.Label(top_frame, text = "GPR 0", fg = "green",padx=5,pady=10,relief=tk.RAISED).pack() 
btn2 = tk.Label(top_frame, text = "GPR 1", fg = "green",padx=5,pady=10,relief=tk.RAISED).pack()
btn3 = tk.Label(top_frame, text = "GPR 2", fg = "green",padx=5,pady=10,relief=tk.RAISED).pack()
btn4 = tk.Label(top_frame, text = "GPR 3", fg = "green",padx=5,pady=10,relief=tk.RAISED).pack()

# labels for  3 Index Registers 1-3
btn5 = tk.Label(top_frame, left_frame, text = "IXR 1", fg = "blue",padx=5,pady=10,relief=tk.RAISED).pack() 
btn6 = tk.Label(top_frame, text = "IXR 2", fg = "blue",padx=5,pady=10,relief=tk.RAISED).pack()
btn7 = tk.Label(top_frame, text = "IXR 3", fg = "blue",padx=5,pady=10,relief=tk.RAISED).pack()

# labels for for PC, MAR, MBR, IR, MFR, Privileged
btn8 = tk.Label(right_frame, text = "PC", fg = "blue",padx=5,pady=10,relief=tk.RAISED).pack(side="right")
btn9 = tk.Label(right_frame, text = "MAR", fg = "blue",padx=5,pady=10,relief=tk.RAISED).pack(side="right")
btn10 = tk.Label(right_frame, text = "MBR", fg = "blue",padx=5,pady=10,relief=tk.RAISED).pack(side="right")
